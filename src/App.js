...
import pic from './images/iphone-mockup.png';
import './App.css';
            ...
            <div className="container">
              <div className="site-header-inner">
                <div className="brand header-brand">
                  <h1 className="m-0">
                    <a href="#">
                      <svg width="32" height="32" viewBox="0 0 32 32" xmlns={logo}>
                        <title>Laurel</title>
                        <defs>
                ...
                <div className="hero-inner">
                  ...
                  <div className="hero-app">
                    <div className="hero-app-illustration">
                      <svg width="999" height="931" xmlns={logo}>
                        <defs>
                    ...
                    <img className="device-mockup" src={pic} alt="App preview" />
                    <div className="hero-app-dots hero-app-dots-1">
                      <svg width="124" height="75" xmlns={logo}>
                        <g fill="none" fill-rule="evenodd">
                    ...
                    <div className="feature is-revealing">
                      <div className="feature-inner">
                        <div className="feature-icon">
                          <svg width="64" height="64" xmlns={logo}>
                            <defs>
                        ...
                        <p className="text-sm mb-0">A pseudo-Latin text used in web design, layout, and printing in place of things to emphasise design.</p>
                      </div>
                    </div>
                    <div className="feature is-revealing">
                      <div className="feature-inner">
                        <div className="feature-icon">
                          <svg width="68" height="64" xmlns={logo}>
                            <defs>
              ...
              <div className="container-sm">
                <div className="media-inner section-inner">
                  ...
                  <div className="media-canvas">
                    <svg width="800" height="450" viewBox="0 0 800 450" xmlns={logo}>
                      <defs>
                    ...
                    <div className="media-control">
                      <svg width="96" height="96" viewBox="0 0 96 96" xmlns={logo}>
                        <defs>
          ...
          <footer className="site-footer">
            <div className="container">
              <div className="site-footer-inner has-top-divider">
                ...
                <ul className="footer-social-links list-reset">
                  <li>
                    <a href="#">
                      ...
                      <svg width="16" height="16" xmlns={logo}>
                ...
                <div className="footer-copyright">&copy; 2018 Laurel, all rights reserved</div>
              </div>
            </div>
          </footer>
        </div>
